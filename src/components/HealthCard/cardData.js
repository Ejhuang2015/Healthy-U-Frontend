...
const jokesCard = {
    header: "Keep being positive",
    title: "Laugh a little",
    body: "Besides providing a sense of pleasure, laughing often can help you live longer. Laughter increases heart and respiratory rates as well as oxygen consumption over a short period. After these initial changes, a person moves into a state of relaxation.",
    footer: "Want to hear a joke?",
    image: {
        image: "./images/seal-laugh.jpg",
        alt: "Laughing seal",
        title: "Laugh a little",
    },
